...
from scripts.star_load.fact_cutomer import fact_customer_sql
from scripts.star_load.fact_marketing_performance import fact_marketing_performance_sql
from scripts.star_load.fact_product_performance import fact_product_performance_sql
from scripts.star_load.fact_sales import fact_sales_sql
...
MERGE_QUERIES = {
    "customer_behaviour":fact_customer_sql,
    "marketing_performance":fact_marketing_performance_sql,
    "sales":fact_sales_sql,
    "product_performance":fact_product_performance_sql,
}
...
with DAG(
    "load_to_star_schema_fact",
    schedule="0 0 * * *",
    default_args=default_args,
    catchup=False,
    max_active_runs=1,
    tags=["star","fact", "merge", "multi-region"],
) as dag:
    merge_group = star_fact_merge_tasks()
