...
def copy_postgres_table_to_table():
    ...
    def transfer_table_data():
        ...
        spark = SparkSession.builder \
            .appName("Postgres Table Copy") \
            .config("spark.jars", "/opt/airflow/jars/postgresql-42.7.3.jar,/opt/airflow/jars/snowflake-jdbc-3.13.17.jar,/opt/airflow/jars/spark-snowflake_2.12-2.16.0-spark_3.2.jar")  \
            .getOrCreate()
        ...
        source_df.write \
            ...
            .option("dbtable", "landing.customers_snowflake") \
            .mode("overwrite") \
            .save()
