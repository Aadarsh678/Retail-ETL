...
# @dag(
#     dag_id="transform_discounts_csv",
...
#     @task
#     def run_discounts_transform(region: str, load_date: str):
...
#         run_discounts_transform(region=region, load_date=load_date)

# transform_discounts_dag = transform_discounts_dag()
...
from scripts.pyspark_jobs.discounts import transform_discounts_table
