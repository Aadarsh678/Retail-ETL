...
# @dag(
#     dag_id="transform_returns_csv",
#     default_args=DEFAULT_ARGS,
#     schedule_interval="@daily",
#     tags=["spark", "transformation", "csv"],
# )
# def transform_returns_dag():

#     @task
#     def run_returns_transform(region: str, load_date: str):
...
#         df_transformed = transform_returns(df_raw, region)
...
#         run_returns_transform(region=region, load_date=load_date)

# transform_returns_dag = transform_returns_dag()
...
from scripts.pyspark_jobs.returns import transform_returns_table

TABLE_NAME = "returns"


@dag(
    dag_id="transform_returns",
...
def transform_returns_dag():
    ...
    def run_transformation_asia():
        transform_returns_table(region="asia", table=TABLE_NAME, load_date="2025-06-08")

    @task
    def run_transformation_eu():
        transform_returns_table(region="eu", table=TABLE_NAME, load_date="2025-06-08")

    @task
    def run_transformation_us():
        transform_returns_table(region="us", table=TABLE_NAME, load_date="2025-06-08")
