...
def transform_shipments_asia(df):
    return df.select(
        ...
        col("shipped_time").alias("shipped_timestamp"),
        safe_to_timestamp_multi_formats(col("est_delivery")).alias("estimated_delivery_date"),
        safe_to_timestamp_multi_formats(col("actual_delivery")).alias("actual_delivery_timestamp"),
