...
# @dag(
#     dag_id="transform_product_variants_csv",
#     default_args=DEFAULT_ARGS,
#     schedule_interval="@daily",
#     tags=["spark", "transformation", "csv"],
# )
# def transform_product_variants_dag():

#     @task
#     def run_product_variants_transform(region: str, load_date: str):
...
#         df_transformed = transform_product_variants(df_raw, region)
...
#         run_product_variants_transform(region=region, load_date=load_date)

# transform_product_variants_dag = transform_product_variants_dag()
...
from scripts.pyspark_jobs.product_variants import transform_product_variants_table

TABLE_NAME = "product_variants"

@dag(
    dag_id="transform_product_variants",
...
def transform_product_variants_dag():
    ...
    def run_transformation_asia():
        transform_product_variants_table(
            region="asia",
            table=TABLE_NAME,
...
dag = transform_product_variants_dag()