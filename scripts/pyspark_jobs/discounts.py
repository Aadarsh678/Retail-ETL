...
def transform_discounts_table(region, table, load_date):
    """
    Transform customers table for a specific region

    Args:
        region (str): Region to process (asia, eu, us)
        table (str): Table name (customers)
        load_date (str): Load date in YYYY-MM-DD format
    """
