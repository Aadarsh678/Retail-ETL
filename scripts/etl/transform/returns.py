...
def transform_returns_asia(df):
    return df.select(
        ...
        col("refund_jpy").alias("refund_amount"),
...
def transform_returns_eu(df):
    return df.select(
        ...
        col("refund_amount_eur").alias("refund_amount"),
...
def transform_returns(df: DataFrame, region: str) -> DataFrame:
    if region == "asia":
        return transform_returns_asia(df)
    elif region == "eu":
        return transform_returns_eu(df)
    elif region == "us":
