...
# @dag(
#     dag_id="transform_products_csv",
#     default_args=DEFAULT_ARGS,
#     schedule_interval="@daily",
#     tags=["spark", "transformation", "csv"],
# )
# def transform_products_dag():

#     @task
#     def run_products_transform(region: str, load_date: str):
...
#         run_products_transform(region=region, load_date=load_date)

# transform_products_dag = transform_products_dag()
...
from scripts.pyspark_jobs.products import transform_products_table

TABLE_NAME = "products"


@dag(
    dag_id="transform_products",
...
def transform_products_dag():
    ...
    def run_transformation_eu():
        transform_products_table(region="eu", table=TABLE_NAME, load_date="2025-06-08")

    @task
    def run_transformation_us():
        transform_products_table(region="us", table=TABLE_NAME, load_date="2025-06-08")
